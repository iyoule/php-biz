...
def generate(out, className, fields) {
  ...
  fields.each() {
    ...
    out.println "     *     decode=@BizJson(field={\"${it.name}\"}, type=\"${it.type}\", require=\"false\", hidden=\"false\"), "
    out.println "     *     encode=@BizJson(field={\"${it.name}\"}, type=\"${it.type}\", require=\"false\", hidden=\"false\")"
    out.println "     * )"
    out.println "     */"
